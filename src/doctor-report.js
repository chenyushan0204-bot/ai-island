...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# AI Island Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- AI Island version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. AI Island does not upload any data. User paths are replaced with `~`, and AI Island app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
